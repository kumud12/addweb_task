...
*
* @FieldFormatter(
*   id = "custom_s_ff_my_custom_formatter",
*   label = @Translation("Field Formatter - Italic style"),
*   field_types = {
*     "string_long",
*     "string"
*   }
* )
*/
class MyCustomFFormatters extends FormatterBase  {
